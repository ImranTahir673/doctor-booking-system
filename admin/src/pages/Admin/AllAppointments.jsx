...
const AllAppointments = () => {
    ...
    return (
        <div className='w-full max-w-6xl m-5'>
            <p className='mb-4 text-xl font-bold text-slate-800'>All Appointments</p>

            <div className='bg-white border border-slate-200 rounded-3xl overflow-hidden shadow-xs text-sm'>
                <div className='hidden sm:grid grid-cols-[0.5fr_3fr_1fr_3fr_3fr_1fr_1fr] grid-flow-col py-3.5 px-6 border-b bg-slate-50 text-slate-500 font-bold text-xs uppercase tracking-wider'>
                    <p>#</p>
                    <p>Patient</p>
                    <p>Age</p>
                    <p>Date & Time</p>
                ...
                <div className='divide-y divide-slate-100'>
                    {appointments.map((item, index) => (
                        <div className='flex flex-col sm:grid grid-cols-[0.5fr_3fr_1fr_3fr_3fr_1fr_1fr] items-center text-slate-700 py-3.5 px-6 gap-2 hover:bg-slate-50/80 transition-all' key={index}>
                            ...
                            <div className='flex items-center gap-2'>
                                <img className='w-8 h-8 rounded-full object-cover bg-indigo-50 border' src={item.docData.image} alt="" />
